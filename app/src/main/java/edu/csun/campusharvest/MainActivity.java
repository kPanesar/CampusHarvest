...
public class MainActivity extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mToolbar.setLogo(R.mipmap.ic_campus_harvest);
        ...
        if(savedInstanceState == null){
            setFragment(0, MyDietFragment.class);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (position){
            case 0:
                ...
                break;
            case 1:
                setFragment(1, MarketFragment.class);
                break;
            case 2:
                setFragment(2, MapFragment.class);
                break;
            case 3:
                setFragment(3, HealthTipFragment.class);
                break;
            case 4:
                setFragment(4, AboutFragment.class);
                break;
            case 5:
                setFragment(5, PhotoContestFragment.class);
                break;
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(itemID == R.id.action_settings){ //Settings button selected
            mTitle = "Settings";
            updateTitle();
